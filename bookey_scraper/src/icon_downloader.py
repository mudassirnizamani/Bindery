...
def main():
    ...
    print("🎨 ICON DOWNLOAD OPTIONS:")
    print("1. Process all extracted JSON files")
    print("2. Example: Download specific icons")
    
    # Option 1: Process existing files
    downloader.process_all_extracted_files()
    
    # Option 2: Example of downloading specific icons
    print("\n" + "="*60)
    print("EXAMPLE: How to download specific icons manually")
    print("="*60)
    ...
    example_mapping = {
        "Finance & Investments": {
            "Economics": {
                ...
                "mini_icon": "https://cdn.bookey.app/_category/20210722200049039.png"
            }
        }
    }
    
    print("📝 Example mapping structure:")
    print(json.dumps(example_mapping, indent=2))
    print("\n💡 To use this, call: downloader.download_specific_icons(your_mapping)")
